...
int maria_set_config_from_file(char *path, Maria_config *config) {
  ...
  if(libconfig_stream != NULL) {
    ...
    if(config_read(&libconfig_object, libconfig_stream) == CONFIG_TRUE) {
      maria_load_setting(libconfig_object, config->dbhost, "database_settings.host");
      maria_load_setting(libconfig_object, config->dbname, "database_settings.database");
      maria_load_setting(libconfig_object, config->dbuser, "database_settings.username");
      maria_load_setting(libconfig_object, config->dbpass, "database_settings.password");
      maria_load_setting(libconfig_object, config->dbport, "database_settings.port");

      maria_load_setting(libconfig_object, config->getpwnam, "nss_queries.getpwnam");
      maria_load_setting(libconfig_object, config->getpwuid, "nss_queries.getpwuid");
      maria_load_setting(libconfig_object, config->getpwent, "nss_queries.getpwent");

      maria_load_setting(libconfig_object, config->getspnam, "nss_queries.getspnam");
      maria_load_setting(libconfig_object, config->getspent, "nss_queries.getspent");

      maria_load_setting(libconfig_object, config->getgrnam, "nss_queries.getgrnam");
      maria_load_setting(libconfig_object, config->getgrid, "nss_queries.getgrid");
      maria_load_setting(libconfig_object, config->getgrent, "nss_queries.getgrent");

      maria_load_setting(libconfig_object, config->memsbygid, "nss_queries.memsbygid");
      maria_load_setting(libconfig_object, config->gidsbymem, "nss_queries.gidsbymem");
