...
Test(maria_config, maria_read_config_takes_values_from_file) {
  ...
  maria_read_config(config, "./test/fixtures/libnss-maria.conf", "./test/fixtures/libnss-maria-root.conf", 0);
...
Test(maria_config, maria_read_config_uses_default_value_if_not_present) {
  ...
  maria_read_config(config, "./test/fixtures/libnss-maria-light.conf", "./test/fixtures/libnss-maria-root-light.conf", 1);
